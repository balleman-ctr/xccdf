...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt">
    ...
    <sch:phase id="both">
        ...
        <!-- copy in all patterns from below, or have user use "#ALL" phase? -->
    </sch:phase>
    ...
    <sch:pattern id="benchmark_rule_group_idref_exists">
        <sch:rule context="xccdf:Profile[xccdf:select|xccdf:refine-rule]/xccdf:select|xccdf:refine-rule">
    ...
    <sch:pattern id="benchmark_value_idref_exists">
        <sch:rule context="xccdf:Profile[xccdf:refine-value|xccdf:set-value|xccdf:set-complex-value]/xccdf:refine-value|xccdf:set-value|xccdf:set-complex-value">
            <sch:let name="idref" value="./@idref"/>
